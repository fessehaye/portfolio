...
const HeroFooter = ({ iconRefs }) => {
  return (
    <footer className="flex justify-start text-white xl:text-gray-200 mb-4 mx-auto xl:mx-0">
      <a
        href="https://github.com/fessehaye"
        target="_blank"
        rel="noopener noreferrer"
      >
        <svg
          className="3xl:h-20 h-12 mr-4 sm:h-16 sm:mr-6 fill-current lg:opacity-70 transition hover:text-white hover:opacity-100"
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
          ref={e => (iconRefs.current[0] = e)}
        >
      ...
      <a
        href="https://www.instagram.com/sfessehaye/"
        target="_blank"
        rel="noopener noreferrer"
      >
        <svg
      ...
      <a
        href="https://www.linkedin.com/in/fessehaye/"
        target="_blank"
        rel="noopener noreferrer"
      >
        <svg
      ...
      <a
        href="mailto:fessehay@ualberta.ca"
        target="_blank"
        rel="noopener noreferrer"
      >
        <svg
